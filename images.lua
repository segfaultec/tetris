...
iLevelLampFrame = lg.newImage("img/levellamp_frame.png")

iLevelLampInner = lg.newImage("img/levellamp_inner.png")
qLevelLampInner_On = lg.newQuad(0, 0, 10, 16, iLevelLampInner)
